  ...
  <ul class="easyui-tree">
    <li>
      ...
      <ul>
            ...
            <li><span><a href="advertisement">广告管理</a></span></li>i>
    ...
    <div id="content" region="center" title="Language" style="padding:5px;">这是主区域</div>
      <div id="bottom" region="south" split="true"  title="" style="padding:2px;height: 30px;text-align: center;" >合众江财4班-胡谢组</div>
